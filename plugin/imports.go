...
var unneededImports = []string{
	...
	"import _ \"github.com/TvdBrink/protoc-gen-gorm/types\"\n",
	"var _ = proto.Marshal\n",
}
...
var (
	...
	gtypesImport   = "github.com/TvdBrink/protoc-gen-gorm/types"
	...
	gerrorsImport  = "github.com/TvdBrink/protoc-gen-gorm/errors"
)
